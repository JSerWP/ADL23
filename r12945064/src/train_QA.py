...
def train():
    ...
    eval_raw_dataset = dataset["valid"]
...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--doc_stride", type=int, default=256, help="The authorized overlap between two part of the context when splitting it is needed.")
